...
export default function GovernancePage() {
  ...
  const proposals = [
    {
      id: 'prop_192',
      title: 'Dispute: iPhone 15 Pro Max Non-Delivery',
      desc: 'Buyer claims item never arrived. Seller provided tracking that shows "Delivered" to wrong zip code.',
      amount: '$1,200',
      timeLeft: '14h 22m',
      votesForSeller: 65,
      votesForBuyer: 35,
    ...
    {
      id: 'prop_195',
      title: 'Dispute: Web Development Milestones',
      desc: 'Seller claims frontend is complete. Buyer argues it does not match Figma designs.',
      amount: '$4,500',
      timeLeft: '2d 4h',
      votesForSeller: 12,
      votesForBuyer: 88,
                ...
                <div key={prop.id} className="p-6 hover:bg-gray-50/50 transition-colors group">
                  <div className="flex justify-between items-start gap-4 mb-3">
                    ...
                    <div className="text-right">
                      <p className="font-bold text-gray-900">{prop.amount}</p>
                      <p className="text-xs text-gray-500 font-medium">{prop.timeLeft} left</p>
                    </div>
                  </div>
                  
                  <p className="text-sm text-gray-600 mb-4 line-clamp-2">{prop.desc}</p>

                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <div className="flex justify-between text-xs font-bold text-gray-500 mb-1">
                        <span>Release</span>
                        <span>{prop.votesForSeller}%</span>
                      </div>
                      <Progress value={prop.votesForSeller} className="h-1.5 bg-gray-100" />
                    </div>
                    <div>
                      <div className="flex justify-between text-xs font-bold text-gray-500 mb-1">
                        <span>Refund</span>
                        <span>{prop.votesForBuyer}%</span>
                      </div>
                      <Progress value={prop.votesForBuyer} className="h-1.5 bg-gray-100" />
                    </div>
                  </div>
